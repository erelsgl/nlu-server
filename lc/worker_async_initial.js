	...
	// silent: false
		...
		_.each(classifiers, function(classifier, key, list){ 
			_(folds).times(function(fold){
				...
				console.vlog("DEBUGMASTER: classifier: "+classifier+" fold: "+ fold + " train size "+data.train.length + " test size " + data.test.length+" process: "+worker.process.id)
